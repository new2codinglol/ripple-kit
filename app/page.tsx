...
function Logo({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} aria-hidden>
      <circle cx="16" cy="16" r="3.2" fill="var(--color-aqua-deep)" />
      <circle cx="16" cy="16" r="8" fill="none" stroke="var(--color-aqua)" strokeWidth="2.2" opacity=".75" />
      <circle cx="16" cy="16" r="13.4" fill="none" stroke="var(--color-aqua)" strokeWidth="1.6" opacity=".4" />
    </svg>
  );
}
  ...
  return (
    <div className="relative z-10">
      ...
      <header className="sticky top-0 z-50 px-4 pt-4">
        <nav className="glass gloss relative mx-auto flex max-w-5xl items-center gap-3 rounded-full py-2 pl-4 pr-2">
